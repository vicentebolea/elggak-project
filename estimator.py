...
def main(argv):
    ...
    # Fetch the data
    (train_x, train_y), (test_x, test_y) = images_loader.load_data()
    ...
    #    input_fn=lambda:images_loader.eval_input_fn(predict_x,
    #                                            labels=None,
    ...
    #    print(template.format(images_loader.SPECIES[class_id],
